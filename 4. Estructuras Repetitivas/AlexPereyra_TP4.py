...
# Ejercicio 3. Sumar todos los enteros entre dos valores dados (excluyendo los extremos)
...
# Ejercicio 6. Números pares del 0 al 100 en orden decreciente
for i in range(100, -1, -1):
    if i % 2 == 0:
        print(i)

# Ejercicio 7. Sumar números entre 0 y un valor dado
limite = int(input("Ingrese un número entero positivo: "))
suma = sum(range(limite + 1))
print("Suma:", suma)

# Ejercicio 8. Contar pares, impares, positivos y negativos entre 100 números
